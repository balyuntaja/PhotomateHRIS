...
class SchedulePolicy
{
    ...
    {
        return $karyawan->can('view_any_schedule');
    }

    /**
     * Determine whether the karyawan can view the model.
     */
    public function view(Karyawan $karyawan, Schedule $schedule): bool
    {
        return $karyawan->can('view_schedule');
    }
    ...
    {
        return $karyawan->can('create_schedule');
    }

    /**
     * Determine whether the karyawan can update the model.
     */
    public function update(Karyawan $karyawan, Schedule $schedule): bool
    {
        return $karyawan->can('update_schedule');
    }

    /**
     * Determine whether the karyawan can delete the model.
     */
    public function delete(Karyawan $karyawan, Schedule $schedule): bool
    {
        return $karyawan->can('delete_schedule');
    }
    ...
    {
        return $karyawan->can('delete_any_schedule');
    }

    /**
     * Determine whether the karyawan can permanently delete.
     */
    public function forceDelete(Karyawan $karyawan, Schedule $schedule): bool
    {
        return $karyawan->can('force_delete_schedule');
    }
    ...
    {
        return $karyawan->can('force_delete_any_schedule');
    }

    /**
     * Determine whether the karyawan can restore.
     */
    public function restore(Karyawan $karyawan, Schedule $schedule): bool
    {
        return $karyawan->can('restore_schedule');
    }
    ...
    {
        return $karyawan->can('restore_any_schedule');
    }

    /**
     * Determine whether the karyawan can replicate.
     */
    public function replicate(Karyawan $karyawan, Schedule $schedule): bool
    {
        return $karyawan->can('replicate_schedule');
    }
    ...
    {
        return $karyawan->can('reorder_schedule');
    }
}
