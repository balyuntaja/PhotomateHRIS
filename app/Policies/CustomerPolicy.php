...
class CustomerPolicy
{
    ...
    public function view(Karyawan $karyawan, Customer $customer): bool
    {
        return $this->check($karyawan);
    }
    ...
    public function update(Karyawan $karyawan, Customer $customer): bool
    {
        return $this->check($karyawan);
    }

    public function delete(Karyawan $karyawan, Customer $customer): bool
    {
        return $this->check($karyawan);
    }
